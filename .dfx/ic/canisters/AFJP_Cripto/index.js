...
import { idlFactory } from './AFJP_Cripto.did.js';
export { idlFactory } from './AFJP_Cripto.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AFJP_CRIPTO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AFJP_Cripto.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AFJP_Cripto canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AFJP_Cripto.did.js")._SERVICE>}
 */
export const AFJP_Cripto = createActor(canisterId);
