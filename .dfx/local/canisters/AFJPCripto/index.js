...
import { idlFactory } from './AFJPCripto.did.js';
export { idlFactory } from './AFJPCripto.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AFJPCRIPTO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AFJPCripto.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AFJPCripto canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AFJPCripto.did.js")._SERVICE>}
 */
export const AFJPCripto = createActor(canisterId);
