...
const translations = {
  en: {
    ...
    'realestate.torres-puerto': 'ICP Towers',
    ...
    'footer.official-icp': 'Official ICP',
    'footer.documentation': 'Documentation',
    'footer.explorer': 'Block Explorer',
    'footer.rights': '© 2025 AFJP Cripto. All rights reserved.',
    
    // Why ICP Section
    'why-icp.title': 'Why choose',
    'why-icp.subtitle': 'Discover the advantages of building our retirement fund on the most advanced blockchain ecosystem',
    'why-icp.interoperability': 'Interoperability',
    'why-icp.interoperability-desc': 'Connect with multiple blockchains and financial systems seamlessly',
    'why-icp.scalability': 'Scalability',
    'why-icp.scalability-desc': 'Process thousands of transactions per second with minimal fees',
    'why-icp.security': 'Security',
    'why-icp.security-desc': 'Secutity model featuring cryptography',
    'why-icp.governance': 'NNS DAO governance',
    'why-icp.governance-desc': 'Democratic governance system for protocol upgrades and decisions',
    ...
    'advantages.dedicated-desc': 'Storing photos and videos costs less thanks to ICP',
  ...
  es: {
    ...
    'realestate.torres-puerto': 'Torres de ICP',
    'realestate.torres-location': 'Puerto Madero, Buenos Aires',
    ...
    'footer.official-icp': 'ICP Oficial',
    'footer.documentation': 'Documentación',
    'footer.explorer': 'Explorador de Bloques',
    'footer.rights': '© 2025 AFJP Cripto. Todos los derechos reservados.',
    
    // Why icp Section
    'why-icp.title': 'Por qué elegir',
    'why-icp.subtitle': 'Descubre las ventajas de construir nuestro fondo de jubilación en el ecosistema blockchain más avanzado',
    'why-icp.interoperability': 'Interoperabilidad',
    'why-icp.interoperability-desc': 'Conecta con múltiples blockchains y sistemas financieros sin problemas',
    'why-icp.scalability': 'Escalabilidad',
    'why-icp.scalability-desc': 'Procesa miles de transacciones por segundo con tarifas mínimas',
    'why-icp.security': 'Seguridad',
    'why-icp.security-desc': 'Modelo de seguridad mediante criptografía',
    'why-icp.governance': 'Gobernanza de DAO NNS',
    'why-icp.governance-desc': 'Sistema de gobernanza democrática para actualizaciones y decisiones del protocolo',
    ...
    'advantages.dedicated-desc': 'Almacenar fotos y videos de los activos cuesta menos gracias a ICP',
